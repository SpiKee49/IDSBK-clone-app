...
function TableRow(props: Props) {
    ...
    return (
        <div className="flex flex-1 flex-row py-2 [&>div>p]:-mt-1  [&>div>p]:text-xl [&>div>p]:font-semibold [&>div>p]:text-gray-800 [&>div>span]:text-[0.6rem] [&>div>span]:font-semibold [&>div>span]:uppercase [&>div>span]:tracking-tight [&>div>span]:text-gray-400 [&>div]:pb-1">
